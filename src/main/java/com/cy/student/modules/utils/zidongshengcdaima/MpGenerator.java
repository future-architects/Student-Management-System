package com.cy.student.modules.utils.zidongshengcdaima;
...
//        gc.setOutputDir("D://workspace/spring-boot-mybatis/src/main/java");
        ...
        dsc.setPassword("Yuanshuai0925");
        dsc.setUrl("jdbc:mysql://rm-bp1i63m5pjswk8c64so.mysql.rds.aliyuncs.com:3306/studentmanagements?useUnicode=true&characterEncoding=utf8");
...
//        strategy.setTablePrefix(new String[] { "studentInformation" });// 此处可以修改为您的表前缀
        ...
        strategy.setInclude(new String[] { "class_table" }); // 需要生成的表
